...
//			if (type & SENSOR_NIGHTMODE || previous_scene_mode == 3)
    ...
    else if (type & SENSOR_CAMCORDER )
    {
        ...
        if (previous_scene_mode == 3)
        {
            printk("[CAM-SENSOR] night mode Record\n");
            s5k4ca_sensor_write_list(client, s5k4ca_fps_7fix, "s5k4ca_fps_7fix");
        }
        else
        {
...
//			msleep(100);
        ...
        case 2: // auto
            if(!af_mode_autoset_initailized)
            {
...
static int s5k4ca_sensor_change_wb(struct i2c_client *client, int type)
{
    ...
    switch (type)
    {
        ...
        case 3:
            ...
            break;
        case 4:
            printk("-> WB Tungsten(incandescent) mode\n"); // incandescent
...
static int s5k4ca_sensor_change_scene_mode(struct i2c_client *client, int type)
{
    ...
    switch (type)
    {
        ...
        case 1:
            printk("-> portrait\n");
            s5k4ca_sensor_write_list(client, s5k4ca_scene_portrait, "s5k4ca_scene_portrait");
            previous_scene_mode = type;
            break;
        case 2:
            printk("-> landscape\n");
            s5k4ca_sensor_write_list(client, s5k4ca_scene_landscape, "s5k4ca_scene_landscape");
            previous_scene_mode = type;
            break;
        case 3:
            printk("-> night\n");
            s5k4ca_sensor_write_list(client, s5k4ca_scene_night, "s5k4ca_scene_night");
            previous_scene_mode = type;
            break;
        case 4:
            printk("-> sunset\n");
            s5k4ca_sensor_write_list(client, s5k4ca_scene_sunset, "s5k4ca_scene_sunset");
            previous_scene_mode = type;
            break;
        case 5:
            printk("-> sports\n");
            s5k4ca_sensor_write_list(client, s5k4ca_scene_sports, "s5k4ca_scene_sports");
            previous_scene_mode = type;
            break;
        case 6:
            printk("-> fireworks\n");
            s5k4ca_sensor_write_list(client, s5k4ca_scene_fireworks, "s5k4ca_scene_fireworks");
            previous_scene_mode = type;
            break;
        case 7:
            printk("-> candlelight\n");
            s5k4ca_sensor_write_list(client, s5k4ca_scene_candlelight, "s5k4ca_scene_candlelight");
            previous_scene_mode = type;
            break;
        case 8:
            printk("-> text\n");
            s5k4ca_sensor_write_list(client, s5k4ca_scene_text, "s5k4ca_scene_text");
            previous_scene_mode = type;
            break;
        case 9:
            printk("-> beach snow\n");
            s5k4ca_sensor_write_list(client, s5k4ca_scene_beach, "s5k4ca_scene_beach");
            previous_scene_mode = type;
            break;
        case 10:
            printk("-> party indoor\n");
            s5k4ca_sensor_write_list(client, s5k4ca_scene_party, "s5k4ca_scene_party");
            previous_scene_mode = type;
            break;
        case 11:
            printk("->againstlight\n");
            s5k4ca_sensor_write_list(client, s5k4ca_scene_againstlight, "s5k4ca_scene_againstlight");
            previous_scene_mode = type;
            break;
        case 12:
            printk("->dawn\n");
            s5k4ca_sensor_write_list(client, s5k4ca_scene_dawn, "s5k4ca_scene_dawn");
            previous_scene_mode = type;
            break;
        default :
