...
//	#define SENSOR_START_CAPTURE	(1 << 31) | ( 3 << 0)  
	#define SENSOR_JPEG_TRANSFER	(1 << 31) | ( 4 << 0)  
//	#define SENSOR_SET_AF			(1 << 31) | ( 5 << 0)  
//	#define SENSOR_GET_AF			(1 << 31) | ( 6 << 0)  
	#define SENSOR_FIX_FRAMERATE	(1 << 31) | ( 7 << 0)  
	#define SENSOR_SET_CAPTURE_SIZE	(1 << 31) | ( 8 << 0)  
	#define SENSOR_GET_JPEG_SIZE	(1 << 31) | ( 9 << 0)  
	#define SENSOR_SET_PREVIEW_SIZE	(1 << 31) | (10 << 0)  
	#define SENSOR_SET_JPEG_QUAL	(1 << 31) | (11 << 0)  
...
extern void clk_cam_enable(void);
extern void clk_cam_disable(void);
